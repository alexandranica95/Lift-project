...
function InitialSetupWithTwoElevators() {
    const elevator1 = new entities_1.Elevator('one');
    const elevator2 = new entities_1.Elevator('two');
    const levels = [{ value: 0 }, { value: 1 }, { value: 2 }, { value: 3 }, { value: 4 }, { value: 5 }];
    const elevatorController = new entities_1.ElevatorController([elevator1, elevator2], levels);
    return { elevator1, elevator2, elevatorController };
}
function InitialSetupWithThreeElevators() {
    const elevator1 = new entities_1.Elevator('one');
    const elevator2 = new entities_1.Elevator('two');
    const elevator3 = new entities_1.Elevator('three');
    const levels = [{ value: 0 }, { value: 1 }, { value: 2 }, { value: 3 }, { value: 4 }, { value: 5 }];
    const elevatorController = new entities_1.ElevatorController([elevator1, elevator2, elevator3], levels);
...
function InitialSetupWithFourElevators() {
    ...
    const elevator2 = new entities_1.Elevator('two');
    const elevator3 = new entities_1.Elevator('three');
    const elevator4 = new entities_1.Elevator('four');
    const levels = [{ value: 0 }, { value: 1 }, { value: 2 }, { value: 3 }, { value: 4 }, { value: 5 }, { value: 6 }, { value: 7 }, { value: 8 }];
    const elevatorController = new entities_1.ElevatorController([elevator1, elevator2, elevator3, elevator4], levels);
